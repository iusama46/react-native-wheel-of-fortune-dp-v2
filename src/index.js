...
class WheelOfFortune extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            finished: false,
            winner: null,
            gameScreen: new Animated.Value(width - 120),
    ...
    prepareWheel = () => {
        ...
        this.fontSize = this.props.options.fontSize ? this.props.options.fontSize : 15;
    ...
    makeWheel = () => {
        ...
        return arcs.map((arc, index) => {
            const instance = d3Shape
                ...
                .padAngle(0)
                .outerRadius(width / 2)
                .innerRadius(this.props.options.innerRadius || 40);
            return {
                path: instance(arc),
                                ...
                                return (
                                    <G key={`arc-${i}`}>
                                        ...
                                        <G
                                            ...
                                            origin={`${x}, ${y}`}>
                                            {this._textRenderOld(x, y, number, i)}
